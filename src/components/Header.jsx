        ...
        <div className="col-lg-4 col-md-4 col-12">
          <div className="top-middle">
            <ul className="useful-links">
              ...
              <li><Link to={"/detalles"} className='nav-link' href="#">Detalles</Link></li>
            </ul>
          </div>
        </div>
        <div className="col-lg-4 col-md-4 col-12">
              ...
              <ul id="nav" className="navbar-nav ms-auto">
                ...
                <li className="nav-item">
                  ...
                  <ul className="sub-menu collapse" id="submenu-1-3">
                    ...
                    <li className="nav-item"><Link to={'/productos/mobile-accessories'} href="cart.html">Accesorios </Link></li>
                    <li className="nav-item"><Link to={'/productos/mens-watches'} href="checkout.html">Relojes</Link></li>
                  </ul>
                </li>
                <li className="nav-item">
